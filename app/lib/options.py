...
class Options:
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='PV', help='folder | cifar10 | mnist ')
        self.parser.add_argument('--train_path', default='./data/PV/train', help='path to train img dataset')
        self.parser.add_argument('--test_path', default='./data/PV/n_test', help='path to test img dataset')
        self.parser.add_argument('--tih', type=int, default=64, help='height of the test img')
        self.parser.add_argument('--tiw', type=int, default=64, help='width of the test img')
        ...
        self.parser.add_argument('--ngf', type=int, default=64,help='size of the generator filter')
        self.parser.add_argument('--ndf', type=int, default=64,help='size of the discriminator filter')
        ...
        self.parser.add_argument('--anomaly_class', default=9, help='Anomaly class idx for mnist and cifar datasets')
        ...
        self.parser.add_argument('--niter', type=int, default=20, help='number of epochs to train for')
        ...
        ##
        # Test
        self.parser.add_argument('--test_batch_size',type=int,default=64,help='batch size of test image')
